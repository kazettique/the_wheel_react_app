                    ...
                    <Row className="r_form_group m-0 my-5 align-items-center">
                        ...
                        <Col className="d-flex p-0 flex-column ml-md-5">
                            ...
                            <Col>
                                ...
                                <small className={"form-text text-muted"+r_color_red} style={{height:'18px'}}>
                                    {this.props.small}
                                </small>
                            </Col>
                        </Col>
                ...
                return (
                    <Row className="r_form_group m-0 my-5">
                        ...
                        <Col className="ml-md-5 radiobtn_con">
                            <label className={"r_tag_style r_capsule radiobtn"+(this.state.btn1?' r_tag_selected':'')} onClick={this.handletagchange('btn1')}>
                                短途
                                <input
                                    type="radio"
                                    name="r_tag"
                            ...
                            <label className={"r_tag_style r_capsule radiobtn"+(this.state.btn2?' r_tag_selected':'')} onClick={this.handletagchange('btn2')}>
                                長途
                                <input type="radio" name="r_tag" value="長途" className="d-none radiobtn"/>
                            </label>
                            <label className={"r_tag_style r_capsule radiobtn"+(this.state.btn3?' r_tag_selected':'')} onClick={this.handletagchange('btn3')}>
                                環島
                                <input type="radio" name="r_tag" value="環島"  className="d-none radiobtn"/>
                            </label>
                            <label className={"r_tag_style r_capsule radiobtn"+(this.state.btn4?' r_tag_selected':'')} onClick={this.handletagchange('btn4')}>
                                跨國
                                <input type="radio" name="r_tag" value="跨國"  className="d-none radiobtn"/>
                            </label>
